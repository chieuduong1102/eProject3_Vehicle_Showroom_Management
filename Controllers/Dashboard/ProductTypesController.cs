...
namespace eProject3_Vehicle_Showroom_Management.Controllers.Dashboard
{
    public class ProductTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ProductType1")] ProductType productType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ProductType1")] ProductType productType)
        {
            if (ModelState.IsValid)
            {
